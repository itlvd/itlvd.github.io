...
Ví dụ: Lớp học có 40 bạn học sinh. Mình cần chọn 3 bạn sau giờ học đi quét nhà. Vậy số cách chọn 3 bạn trong 40 bạn là $$ C_{40}^{3} = \frac{40!}{3!.(40-3)!} = 9880$$. Thế là mình gọi 3 bạn: "Dũng, Minh, Khôi". Thì:
...
Cách tính rất đơn giản: với $$A_{5}^{3} = \frac{5!}{(5-3)!} = \frac{5.4.3.2.1}{2.1}=5.4.3$$ bạn có nhận ra với k bằng  bao nhiêu thì ta lấy tích của các số từ n cho đến n - k. Để tránh hiểu sai, nên mình ghi hơi khó hiểu. 
